...
![Sotu Trump China](sotu_trump_china.png)

We can also increment it even more.
To check the color names in R, check [this link](https://r-charts.com/colors/), or [this](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf), or search in internet for "R color palettes".
...
page_html <- text |> 
  ...
  color_text(pattern = "USA|U\\.S\\.A\\.|America|United States", # Regex pattern
    color_txt = "lightblue", 
    mouseover_txt = "USA" ) |>
  color_text(pattern = 
    "(?i)\\b(Hispanic|Mexic|Cuba|Hondur|Hait|Guatemal|El Salvador|Nicaragua)", # Regex pattern
    color_txt = "lightblue", 
    mouseover_txt = "latin" ) |>
