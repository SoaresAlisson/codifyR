...
Option 1: using [devtools](https://devtools.r-lib.org/reference/install.html)

```{r eval=FALSE}
# install.packages("devtools")
devtools::install_github("SoaresAlisson/codifyR")
```
Option 2: install using [{pak}](https://pak.r-lib.org/reference/pkg_install.html) package
``` r
...
See the vignettes and function references at the [web page of the package](https://soaresalisson.github.io/codifyR/)

## TODO - Future improvements

Some improvements planned to the package. Not necessarily all of them will be implemented.

- Use dataframe and list object as input to the text tagger
- import yaml file with dictionary of terms as categories and description
...
- Use a word embeddings suggestion system of new terms to the categories.
